		...
		<div id="rat-item">
			...
			<a href="<?php bp_group_permalink(); ?>"><?php bp_group_avatar( 'type=thumb&width=50&height=50' ); ?></a>
				...
				<?php do_action( 'bp_directory_groups_actions' ); ?>
                    <img src="<?php echo get_template_directory_uri()?>/images/ico_act_18.png" width="18" height="18" align="absmiddle" /> <?php printf( __( 'active %s', 'buddypress' ), bp_get_group_last_active() ); ?>  | 
					<img src="<?php echo get_template_directory_uri()?>/images/ico_comun_18.png" width="18" height="18" align="absmiddle" /> <?php bp_group_type(); ?>  | 
